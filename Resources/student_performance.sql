...
-- Name: stu_math; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.stu_math (
    school character varying,
    sex character varying,
    age integer,
    address character varying,
    famsize character varying,
    "Pstatus" character varying,
    "Medu" integer,
    "Fedu" integer,
    "Mjob" character varying,
    "Fjob" character varying,
    reason character varying,
    guardian character varying,
    traveltime integer,
    studytime integer,
    failures integer,
    schoolsup character varying,
    famsup character varying,
    paid character varying,
    activities character varying,
    nursery character varying,
    higher character varying,
...
-- Name: stu_por; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.stu_por (
)
...
-- Dependencies: 215
-- Data for Name: stu_math; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.stu_math (school, sex, age, address, famsize, "Pstatus", "Medu", "Fedu", "Mjob", "Fjob", reason, guardian, traveltime, studytime, failures, schoolsup, famsup, paid, activities, nursery, higher, internet, romantic, famrel, freetime, goout, "Dalc", "Walc", health, absences, "G1", "G2", "G3") FROM stdin;
...
--
-- TOC entry 4781 (class 0 OID 17725)
-- Dependencies: 216
-- Data for Name: stu_por; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.stu_por (school, sex, age, address, famsize, "Pstatus", "Medu", "Fedu", "Mjob", "Fjob", reason, guardian, traveltime, studytime, failures, schoolsup, famsup, paid, activities, nursery, higher, internet, romantic, famrel, freetime, goout, "Dalc", "Walc", health, absences, "G1", "G2", "G3") FROM stdin;
...
-- Completed on 2025-03-10 21:04:00
